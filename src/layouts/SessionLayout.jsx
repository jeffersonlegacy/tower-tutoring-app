...
export default function SessionLayout() {
    ...
    return (
        <div className="flex flex-col h-[100dvh] w-screen overflow-hidden bg-slate-900 relative">
            ...
            <header className="p-4 text-center text-xl font-bold bg-slate-800/90 backdrop-blur-md text-white shadow flex justify-between items-center z-10 border-b border-slate-700 shrink-0 w-full relative">
                <div className="flex items-center gap-3">
                    ...
                    <span className="bg-gradient-to-r from-blue-400 to-cyan-300 bg-clip-text text-transparent">ToweR Tutoring</span>
                </div>
